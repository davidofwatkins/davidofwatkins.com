<div class="clearfloats"></div>
    ...
    <div id="footer">
		...
		<div id="likebuttons-mobile">
			<fb:like href="http://davidofwatkins.com" send="false" layout="button_count" width="50" show_faces="false"></fb:like>
			<g:plusone href="http://davidofwatkins.com" annotation="inline" width="120"></g:plus>
		</div>
