...
<?php include("includes/header.php"); ?>
	...
	<div id="supercontent"><div id="content">
            ...
            <div id="welcome-text">          
                ...
                <p>I'm David Watkins: developer, video editor, technology enthusiast, and musician. I graduated from <a href="http://www.champlain.edu/" target="_blank">Champlain College</a> in Burlington, VT in 2013, where I received my Bachelor of Science in Computer Information Technology and a minor in Web Development. Some of my personal projects include <a href="https://chrome.google.com/webstore/detail/rescroller/ddehdnnhjimbggeeenghijehnpakijod" target="_blank">Rescroller for Chrome</a> and <a href="https://play.google.com/store/apps/details?id=dwat.ccshuttletracker" target="_blank">a Champlain College shuttle tracker for Android</a>. Currently, I'm a software engineer at <a href="http://zenput.com" target="_blank">Zenput</a>, a small company in San Francisco that provides businesses with tools to analyze and collaborate on real-time data, collected via a mobile app by employees in the field. I believe technology has the potential to improve our lives in exciting, creative, and unexpected ways. This is my personal website, so please feel free to read more about me, <a href="<?= SITEROOT ?>portfolio">explore my portfolio</a>, or <a href="<?= SITEROOT ?>contact">contact me</a>.</p>

                <p>Thank you, and I hope you enjoy your stay.</p>
            ...
            <div class="readmore">
                ...
                <p>Technology and electronics have captured my curiosity and interest for most of my life. My passion has expanded from not only how computers work to how they affect our lives. The internet has revolutionized our ability to share, connect, and collaborate with nearly anyone and remain updated in real-time with current events across the globe. It has given us easier access to information and communication than ever before. With a plethora of growing devices and platforms, I'm thrilled to be part of an such an innovative industry with such high potential.</p>

                <div class="imageframe left"><img style="width: 175px;" title="Photo credit: Jim Courtney" src="<?= SITEROOT ?>images/grindjam.jpg" /></div>
                <p>In contrast to code and tech, music is a vital passion of mine. I have been a member of <a href="http://www.sccchorus.org/" target="_blank">choruses</a>, school musicals, and vocal-study singing workshops. In college, I learned to play guitar and regularly participated in my school's weekly open mic: <a href="http://www.thegrindlive.com/" target="_blank">The Grind</a>. In coordination with music, I've developed a passion for video editing and have used it to document and share many of my experiences.</p>

                <p>Regardless of what the future holds, I hope to continue exploring these passions. Never do I want to stop learning. We live in an exciting era where the growth of technology has the potential to improve and change our lives in unpredictable and unimaginable ways.</p>
